...
<head>
    ...
    <title>Data Pengunjung | Sri-Shop</title>
    <!-- CSS -->
...
<body>
	...
	<section id="about">
		<div class="container">
			<div>
			<br><br><a href="data2.php" class="btn btn-danger">Data Pembelian</a>
				<center><br><br><font color="orange" size="6">Data Pelanggan</font></center><!--tabel-->
				<br><table class="table table-hover">
					...
					<?php
						$query=mysql_query("select * from srishop_pengunjung");	
						$no=1;										
					...
					<tr>
						...
						<td><a href="edit_data.php?id=<?php echo $lihat['id'] ?>" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i> Edit</a>		
							<a href="hapus_data.php?id=<?php echo $lihat['id'] ?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Hapus</a></td>   
					</tr>
					<?php
						}
					?>
