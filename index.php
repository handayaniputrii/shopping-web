				...
				<div class="col-sm-9 padding-right">
					...
					<div class="features_items"><!--features_items-->
						<?php $sql = "select * FROM srishop_simpan";
									  ...
									  while (($data = mysql_fetch_array($tampil))) {if($data['id'] < 30)
						{?>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
											<div class="image"><small><?php echo "<img src='gambar/".$data['gambar']."'";?> alt="" /></a></small></div>
					...
					<ul class="pagination">
							...
							<li><a href="index2.php">&raquo;</a></li>
					</ul>
				</div>
			</div>
		</div>	
